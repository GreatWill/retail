...
import com.svjia.common.IntentionSql;
...
public class IntentionService {
    ...
    private Log logger = LogFactory.getLog(IntentionService.class);
    ...
    public Map<String,String> Total() throws Exception{
        ...
        PreparedStatement ps = connection.prepareStatement(IntentionSql.TOTAL_ALL);
    ...
    private PreparedStatement getIncrementPsByType(String type, Connection conn) throws SQLException {
        PreparedStatement ps = conn.prepareStatement(IntentionSql.TOTAL_BY_TIME);
    ...
    private  PreparedStatement getRatePsByType(String type, String rate, Connection conn) throws Exception{
        PreparedStatement ps = conn.prepareStatement(IntentionSql.RATE_BY_TIME);
