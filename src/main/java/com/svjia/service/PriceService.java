...
import com.svjia.common.PriceSql;
...
public class PriceService {
    ...
    private Log logger = LogFactory.getLog(PriceService.class);
    ...
    public Map<String,String> Total() throws Exception{
        ...
        PreparedStatement ps = connection.prepareStatement(PriceSql.TOTAL_ALL);
    ...
    private PreparedStatement getIncrementPsByType(String type, Connection conn) throws SQLException {
        PreparedStatement ps = conn.prepareStatement(PriceSql.TOTAL_BY_TIME);
    ...
    private  PreparedStatement getRatePsByType(String type, String rate, Connection conn) throws Exception{
        PreparedStatement ps = conn.prepareStatement(PriceSql.RATE_BY_TIME);
        ...
        ps.setString(5,preDate[0]);
        ps.setString(6,preDate[1]);
