...
import com.svjia.common.AccountSql;
...
public class AccountService {
    ...
    private Log logger = LogFactory.getLog(AccountService.class);
    ...
    public Map<String,String> Total() throws Exception{
        ...
        PreparedStatement ps = connection.prepareStatement(AccountSql.TOTAL_ALL);
    ...
    private PreparedStatement getIncrementPsByType(String type, Connection conn) throws SQLException {
        PreparedStatement ps = conn.prepareStatement(AccountSql.TOTAL_BY_TIME);
    ...
    private  PreparedStatement getRatePsByType(String type, String rate, Connection conn) throws Exception{
        PreparedStatement ps = conn.prepareStatement(AccountSql.RATE_BY_TIME);
        ...
        ps.setString(4,dateRateArg[0]);
        ps.setString(5,dateRateArg[1]);
        ps.setString(6,dateRateArg[0]);
        return ps;
    }
