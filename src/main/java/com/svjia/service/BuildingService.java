...
import com.svjia.common.BuildingSql;
...
public class BuildingService {
    ...
    private Log logger = LogFactory.getLog(BuildingService.class);
    ...
    public Map<String,String> Total() throws Exception{
        ...
        PreparedStatement ps = connection.prepareStatement(BuildingSql.TOTAL_ALL);
    ...
    private PreparedStatement getIncrementPsByType(String type, Connection conn) throws SQLException {
        PreparedStatement ps = conn.prepareStatement(BuildingSql.TOTAL_BY_TIME);
    ...
    private  PreparedStatement getRatePsByType(String type, String rate, Connection conn) throws Exception{
        PreparedStatement ps = conn.prepareStatement(BuildingSql.RATE_BY_TIME);
