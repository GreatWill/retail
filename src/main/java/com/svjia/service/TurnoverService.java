...
public class TurnoverService {
    ...
    private Log logger = LogFactory.getLog(TurnoverService.class);
    ...
    public Map<String,String> Total() throws Exception{
        ...
        PreparedStatement ps = connection.prepareStatement(TurnoverSql.TOTAL_ALL);
    ...
    private PreparedStatement getIncrementPsByType(String type, Connection conn) throws SQLException {
        PreparedStatement ps = conn.prepareStatement(TurnoverSql.TOTAL_BY_TIME);
    ...
    private  PreparedStatement getRatePsByType(String type, String rate, Connection conn) throws Exception{
        PreparedStatement ps = conn.prepareStatement(TurnoverSql.RATE_BY_TIME);
